...
public class DAO_User
{
    ...
    public void truncateTables()
    {
        using (var db = new Mapping())
        {
            ...
            db.candidato.SqlQuery("ALTER SEQUENCE votaciones.conteo_id_seq RESTART WITH 1");
            db.candidato.SqlQuery("ALTER SEQUENCE votaciones.votantes_id_seq RESTART WITH 1");
            db.SaveChanges();
        }
    }
}